...
public class Certificate extends JFrame {
	...
	public static JPanel contentPane, PanelExport;
	public JButton exitCer,exportCer;
	public JLabel idCer, nameCer, dateCer, monthCer, addressCer, chasicCer, engineCer, yearCer, brandCer, modelCer,
			colorCer, plateCer;
	...
	public Certificate() {
		...
		PanelExport.setBounds(10, 10, 1230, 382);
		contentPane.add(PanelExport);
		PanelExport.setLayout(null);

		JPanel panel = new JPanel();
		panel.setBounds(0, 0, 611, 382);
		PanelExport.add(panel);
		...
		panel_1.setBounds(619, 0, 611, 382);
		PanelExport.add(panel_1);
		...
		exportCer = new JButton("Xu\u1EA5t \u1EA3nh");
